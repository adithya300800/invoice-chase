...
${daysOverdue > 30 ? `It's been a little over a month now, and I just wanted to make sure this didn't slip through the cracks.` : `Just a quick check-in — this one slipped past its due date of ${dueDate}.`}
